                    ...
                    <div id="login-box" class="col-md-12">
                        @if (!Session::has('result'))
                            <form id="login-form" class="form" action="{{route('approval.store')}}" method="POST">
                                @csrf
                                <h3 class="text-center text-info">Paid Leave Approval</h3>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="reason" id="" cols="30" rows="5" class="form-control" placeholder="I've planning family trip"></textarea>
                                </div>
                                ...
                                <small>Paid leave approval must be max applied H-1</small>
                            </form>
                        @else
                            @php
