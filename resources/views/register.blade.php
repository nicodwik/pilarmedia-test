            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="{{route('sick.store')}}" method="POST">
                            @csrf
                            <h3 class="text-center text-info">Employee Register</h3>
                            <div class="form-group">
                                <label for="name" class="text-info">Name:</label><br>
                                <input type="name" name="name" id="name" class="form-control" placeholder="My Full Name">
                            </div>
                            <div class="form-group">
